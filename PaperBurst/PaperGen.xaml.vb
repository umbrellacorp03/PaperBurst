...
Class MainWindow
    Private Sub GeneratePaperWallet_Click(sender As Object, e As RoutedEventArgs) Handles generatePaperWallet.Click
        ...
        Else
            ...
            graph.DrawImage(My.Resources.Backg, XUnit.FromCentimeter(0), XUnit.FromCentimeter(0), XUnit.FromCentimeter(29.7), XUnit.FromCentimeter(21))
            ...
            If dialog.ShowDialog() = DialogResult Then
        ...
        End If
    End Sub
    Private Sub generatePassphrase_Click_1(sender As Object, e As RoutedEventArgs) Handles generatePassphrase.Click
        ...
        End If
        Dim Bint As New Numerics.BigInteger(b)
    ...
    Private Shared Sub genPassphrase(ByVal document As PdfDocument, passphrase As String, graph As XGraphics)
        ...
        Dim font As MigraDoc.DocumentObjectModel.Font = New MigraDoc.DocumentObjectModel.Font("Arial", 7)
    ...
    Private Function MakeSeed(ByVal nrWords As Integer) As String
        ...
        For t As Integer = 0 To (nrWords * 2) - 1 Step 2
            KeySeed &= Wordlist.PassPhraseWords(((rngdata(t) * 256) + rngdata(t + 1)) Mod 1626) & " "
        Next
